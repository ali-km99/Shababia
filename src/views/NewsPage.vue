        ...
        >
          <div class="relative rounded-xl overflow-hidden shadow-lg">
            ...
            <div class="relative w-full h-80">
              ...
              <div
                class="absolute inset-0 bg-gradient-to-t from-10% from-purple-600 to-transparent to-60%"
              ></div>
            </div>
...
const tabs = ref([
  ...
  { label: 'أخبار فنية', value: 'social' },
  { label: 'أخبار رياضية ', value: 'cultural' },
  { label: 'اخبار أقتصادية', value: 'sports' },
])
